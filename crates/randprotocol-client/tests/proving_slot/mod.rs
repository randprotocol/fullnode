...
//! (this chain's three-second blocks, and `PROVING` in `rand-node`'s `cluster.rs`): blocks slow
...
//!
//! This file has a twin at `crates/randprotocol-node/tests/proving_slot/mod.rs`, because both test
