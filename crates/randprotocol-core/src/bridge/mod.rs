...
/// A bridge-side asset identifier: `blake3("rand-bridge-asset" ||
...
/// Domain-separated, chain-shaped asset id: `blake3("rand-bridge-asset" ||
/// token_chain BE u16 || token_address)`.
pub fn asset_id(token_chain: u16, token_address: &[u8; 32]) -> AssetId {
    ...
    Hash::digest_domain(b"rand-bridge-asset", &data)
}
...
mod tests {
    ...
    fn asset_id_is_domain_separated_blake3() {
        let mut buf = b"rand-bridge-asset".to_vec();
