...
fn zusd_genesis(validators: &[randprotocol_core::Keypair]) -> Genesis {
    Genesis {
        ...
        tokens: Some(TokensConfig { registration_fee: REGISTRATION_FEE, mint_cap_per_day: MINT_CAP, max_tokens: None, burn_registration_fee: None, bound_note_value: None, tokens: vec![] }),
        aggregation: None,
