use randprotocol_zkvm::keccak::{keccak256, keccak_f, state_to_words, words_to_state, RC, ROT};
...
mod chip {
    ...
    use randprotocol_zkvm::keccak::{keccak_f, state_to_words, words_to_state};
    use randprotocol_zkvm::tables::keccak::{self, col, keccak_trace, KeccakEvent, BLOCK, ROUNDS};
...
mod harness {
    ...
    use randprotocol_zkvm::tables::keccak::{col, keccak_trace, KeccakAir, KeccakEvent, BLOCK, ROUNDS};
...
mod unpaid {
    ...
    use randprotocol_zkvm::tables::keccak::{col, keccak_trace, BLOCK, ROUNDS};
    use randprotocol_zkvm::tables::F;
    use p3_field::PrimeCharacteristicRing;
