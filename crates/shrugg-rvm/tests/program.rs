...
use shrugg_rvm::emulator::Event;
use shrugg_rvm::isa::{Instr, Op, Program, F};
use shrugg_rvm::machine::{program_log_height, FriProfile, Machine, Tier};
use shrugg_rvm::tables::program::{col, pre, program_trace, ProgramAir};
use std::sync::Arc;
...
fn the_verifier_key_binds_the_program() {
    ...
    let roots = |k: &p3_batch_stark::CommonData<shrugg_rvm::machine::Config>| {
